<?php $__env->startSection('title', 'Accueil - Check-in'); ?>
...
<div class="animate-in">
    ...
    <div class="mb-8">
        ...
        <p class="mt-1 text-gray-500">Interface de pointage - <?php echo e(now()->format('d F Y')); ?></p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-400 text-white hover-lift">
            <div class="relative z-10">
                <div class="text-4xl font-bold"><?php echo e($statistics['today_events']); ?></div>
        ...
        <div class="relative overflow-hidden p-6 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-400 text-white hover-lift">
            <div class="relative z-10">
                <div class="text-4xl font-bold"><?php echo e($statistics['today_waiting']); ?></div>
        ...
        <div class="divide-y divide-gray-50">
            ...
            <div class="p-6 hover:bg-gray-50 transition-colors">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900"><?php echo e($event->title); ?></h3>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-3 px-4 py-2 bg-gray-50 rounded-xl">
                            <div class="text-center">
                                <div class="text-lg font-bold text-emerald-600"><?php echo e($event->present_count); ?></div>
                                <div class="text-xs text-gray-500">Présents</div>
                            </div>
                            <div class="w-px h-8 bg-gray-200"></div>
                            <div class="text-center">
                                <div class="text-lg font-bold text-amber-600"><?php echo e($event->confirmed_count); ?></div>
                                <div class="text-xs text-gray-500">En attente</div>
                            </div>
                        </div>
                        
                        <a href="<?php echo e(route('checkin.index', $event)); ?>" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-emerald-600 rounded-full hover:bg-emerald-700 transition-all hover:scale-[1.02] active:scale-[0.98]">
                ...
                <div class="mt-4">
                    <div class="flex items-center justify-between text-sm mb-2">
                        ...
                        <span class="font-medium text-gray-900">
                            <?php echo e($event->present_count + $event->confirmed_count > 0 ? round(($event->present_count / ($event->present_count + $event->confirmed_count)) * 100) : 0); ?>%
                        </span>
                    </div>
                    <div class="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
                        <div class="h-full bg-gradient-to-r from-emerald-600 to-emerald-400 rounded-full transition-all duration-500" 
                            style="width: <?php echo e($event->present_count + $event->confirmed_count > 0 ? round(($event->present_count / ($event->present_count + $event->confirmed_count)) * 100) : 0); ?>%">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/dashboard-accueil.blade.php ENDPATH**/ ?>