...
<head>
    ...
    <title>Inscription confirmée - <?php echo e($event->title); ?></title>
    ...
    <div class="max-w-lg w-full animate-in">
        <div class="glass rounded-3xl shadow-2xl overflow-hidden text-center p-10">
            ...
            <div class="bg-gray-50 rounded-2xl p-6 mb-6">
                <h2 class="font-semibold text-gray-900 mb-4"><?php echo e($event->title); ?></h2>
                <div class="space-y-2 text-sm text-gray-600">
                    <div class="flex items-center justify-center gap-2">
                        <svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span><?php echo e($event->date->format('d F Y')); ?></span>
                    </div>
                    <div class="flex items-center justify-center gap-2">
                        <svg class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            <a href="<?php echo e(route('public.register', $event->registration_token)); ?>" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 transition-colors">
...
<?php /**PATH /var/www/html/resources/views/public/confirmation.blade.php ENDPATH**/ ?>