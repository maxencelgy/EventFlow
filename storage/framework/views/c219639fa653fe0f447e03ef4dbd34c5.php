...
<div class="animate-in">
    ...
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-8">
        <div>
            <div class="flex items-center gap-3 mb-3">
                <span class="inline-flex items-center px-3 py-1 text-sm font-medium rounded-full <?php echo e($event->status === 'published' ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-600'); ?>">
                    <?php echo e($event->status === 'published' ? '● Publié' : ucfirst($event->status)); ?>
            ...
            <p class="mt-2 text-gray-500">Organisé par <?php echo e($event->user->name); ?></p>
        </div>
        
        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('events.registrations.create', $event)); ?>" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-gray-900 rounded-full hover:bg-gray-800 transition-all duration-300 hover:shadow-lg hover:shadow-gray-900/25 hover:scale-[1.02] active:scale-[0.98]">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                </svg>
                Inscrire
            </a>
            <?php if($event->date->isToday() || $event->date->isPast()): ?>
                <a href="<?php echo e(route('checkin.index', $event)); ?>" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-emerald-600 rounded-full hover:bg-emerald-700 transition-all duration-300 hover:scale-[1.02]">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('events.edit', $event)); ?>" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-gray-700 bg-gray-100 rounded-full hover:bg-gray-200 transition-all">
                Modifier
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        <div class="bg-white rounded-2xl border border-gray-100 p-5 text-center">
            <div class="text-3xl font-bold text-gray-900"><?php echo e($statistics['confirmed']); ?></div>
            <div class="mt-1 text-sm text-gray-500">Confirmés</div>
        </div>
        <div class="bg-white rounded-2xl border border-gray-100 p-5 text-center">
            <div class="text-3xl font-bold text-amber-600"><?php echo e($statistics['waiting']); ?></div>
            <div class="mt-1 text-sm text-gray-500">En attente</div>
        </div>
        <div class="bg-white rounded-2xl border border-gray-100 p-5 text-center">
            <div class="text-3xl font-bold text-emerald-600"><?php echo e($statistics['present']); ?></div>
            <div class="mt-1 text-sm text-gray-500">Présents</div>
        </div>
        <div class="bg-white rounded-2xl border border-gray-100 p-5 text-center">
            <div class="text-3xl font-bold text-red-600"><?php echo e($statistics['absent']); ?></div>
            <div class="mt-1 text-sm text-gray-500">Absents</div>
        </div>
        <div class="bg-white rounded-2xl border border-gray-100 p-5 text-center">
            <div class="text-3xl font-bold text-gray-400"><?php echo e($statistics['cancelled']); ?></div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="p-6 space-y-4">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900"><?php echo e($event->date->format('d F Y')); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900"><?php echo e($event->start_time); ?> - <?php echo e($event->end_time); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-gray-900"><?php echo e($event->max_participants); ?> places</p>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="<?php echo e(route('events.registrations.index', $event)); ?>" class="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
                    Voir tout →
                </a>
            </div>
            <div class="divide-y divide-gray-50">
                <?php $__empty_1 = true; $__currentLoopData = $event->registrations->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between px-6 py-4 hover:bg-gray-50 transition-colors">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo e($registration->participant->organization ?? 'Non spécifié'); ?></p>
                            </div>
                        </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="px-6 py-12 text-center">
                        ...
                        <a href="<?php echo e(route('events.registrations.create', $event)); ?>" class="mt-3 inline-block text-sm font-medium text-gray-900 hover:underline">
        ...
        <div class="p-6">
            <div class="flex items-center gap-4">
                <div class="flex-1 relative">
                    <input type="text" id="magic-link" value="<?php echo e(route('public.register', $event->registration_token)); ?>" readonly
                ...
                <a href="<?php echo e(route('public.register', $event->registration_token)); ?>" target="_blank" class="inline-flex items-center gap-2 px-6 py-3.5 text-sm font-semibold text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 transition-all">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="mt-8 bg-white rounded-2xl border border-red-100 overflow-hidden">
        ...
        <div class="p-6 flex items-center justify-between">
            ...
            <form action="<?php echo e(route('events.destroy', $event)); ?>" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet événement ?');">
                <?php echo csrf_field(); ?>
