...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'EventFlow'); ?> - Gestion d'événements</title>
...
<body class="min-h-screen bg-gray-50 font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-72 glass border-r border-gray-200/50">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    <a href="<?php echo e(route('dashboard')); ?>" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('dashboard') ? 'active bg-gray-900 text-white shadow-lg shadow-gray-900/20' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <?php if(auth()->user()->isAdmin() || auth()->user()->isChefProjet()): ?>
                    <a href="<?php echo e(route('events.index')); ?>" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('events.*') ? 'active bg-gray-900 text-white shadow-lg shadow-gray-900/20' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    ...
                    <a href="<?php echo e(route('participants.index')); ?>" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('participants.*') ? 'active bg-gray-900 text-white shadow-lg shadow-gray-900/20' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'); ?>">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="p-4 border-t border-gray-200/50">
                    <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500 truncate"><?php echo e(ucfirst(str_replace('_', ' ', auth()->user()->role))); ?></p>
                        </div>
        ...
        <!-- Main Content -->
        <main class="<?php echo e(auth()->check() ? 'ml-72' : ''); ?> flex-1 min-h-screen">
